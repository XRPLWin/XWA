...
final class OracleSet extends XRPLParserBase
{
  ...
  protected function parseTypeFields(): void
  {
    ...
    if(!in_array($parsedType, $this->acceptedParsedTypes))
      throw new \Exception('Unhandled parsedType ['.$parsedType.'] on OracleSet with HASH ['.$this->data['hash'].'] and perspective ['.$this->reference_address.']');
