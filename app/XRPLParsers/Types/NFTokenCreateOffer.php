  ...
  protected function parseTypeFields(): void
  {
    ...
    if(isset($this->data['eventList']['primary'])) {
      ...
      if($this->data['eventList']['primary']['currency'] !== 'XRP') {
        throw new \Exception('Unhandled non XRP value on NFTokenCreateOffer with HASH ['.$this->data['hash'].'] and perspective ['.$this->reference_address.']');
      }
    }
  }
