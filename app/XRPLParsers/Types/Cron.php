...
final class Cron extends XRPLParserBase
{
  ...
  protected function parseTypeFields(): void
  {
    ...
    if(!in_array($parsedType, $this->acceptedParsedTypes))
      throw new \Exception('Unhandled parsedType ['.$parsedType.'] on Cron with HASH ['.$this->data['hash'].'] and perspective ['.$this->reference_address.']');
